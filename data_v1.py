...
wfmastery_data = [
    ...
    i(group_consts.Primary, "Buzlok", sub_consts.Rifle),
    i(group_consts.Primary, "Dera", sub_consts.Rifle),
    ...
    i(group_consts.Primary, "Grinlok", sub_consts.Rifle),
    i(group_consts.Primary, "Harpak", sub_consts.Rifle),
    i(group_consts.Primary, "Hema", sub_consts.Rifle),
    ...
    i(group_consts.Primary, "Mutalist Quanta", sub_consts.Rifle),
    i(group_consts.Primary, "Opticor", sub_consts.Rifle),
    i(group_consts.Primary, "Paracyst", sub_consts.Rifle),
    ...
    i(group_consts.Primary, "Supra", sub_consts.Rifle),
    i(group_consts.Primary, "Sybaris", sub_consts.Rifle),
    ...
    i(group_consts.Primary, "Synapse", sub_consts.Rifle),
    #sub_consts.Shotguns
    ...
    i(group_consts.Primary, "Phage", sub_consts.Shotgun),
    ...
    #Snipers
    i(group_consts.Primary, "Lanka", sub_consts.Shotgun),
    i(group_consts.Primary, "Rubico", sub_consts.Shotgun),
    i(group_consts.Primary, "Snipetron", sub_consts.Shotgun),
    i(group_consts.Primary, "Snipetron Vandal", sub_consts.Shotgun),
    i(group_consts.Primary, "Vectis", sub_consts.Shotgun),
    i(group_consts.Primary, "Vectis Prime", sub_consts.Shotgun),
    i(group_consts.Primary, "Vulkar", sub_consts.Shotgun),
    i(group_consts.Primary, "Vulkar Wraith", sub_consts.Shotgun),
    #Bows
    ...
    i(group_consts.Primary, "Ogris", sub_consts.Launchers),
    ...
    i(group_consts.Primary, "Torid", sub_consts.Launchers),
    i(group_consts.Primary, "Zarr", sub_consts.Launchers),
    #wtf
    i(group_consts.Primary, "Javlok", sub_consts.Spearguns),  #WTF

    #Secondaries
    i(group_consts.Secondary, "Acrid", sub_consts.Single),
    ...
    i(group_consts.Secondary, "Embolist", sub_consts.Continuous),
    i(group_consts.Secondary, "Gammacor", sub_consts.Continuous),
    i(group_consts.Secondary, "Gammacor Synoid", sub_consts.Continuous),
    i(group_consts.Secondary, "Nukor", sub_consts.Continuous),
    i(group_consts.Secondary, "Spectra", sub_consts.Continuous),
    ...
    i(group_consts.Secondary, "Kohmak", sub_consts.Shotgun),
    i(group_consts.Secondary, "Pyrana", sub_consts.Shotgun),
    ...
    i(group_consts.Secondary, "Akstiletto", sub_consts.Dual),
    ...
    i(group_consts.Secondary, "Dual Cestra", sub_consts.Dual),
    i(group_consts.Secondary, "Dual Cestra Secura", sub_consts.Dual),
    i(group_consts.Secondary, "Dual Toxocyst", sub_consts.Dual),
    i(group_consts.Secondary, "Staticor", sub_consts.Dual),
    ...
    i(group_consts.Secondary, "Castanas", sub_consts.Thrown),
    ...
    i(group_consts.Secondary, "Talons", sub_consts.Thrown),
    #Melee
    ...
    i(group_consts.Melee, "Prova", sub_consts.Machete),
    ...
    i(group_consts.Melee, "Okina", sub_consts.Dual_Dagger),
    ...
    i(group_consts.Melee, "Silva & Aegis", sub_consts.Sword_Shield),
    i(group_consts.Melee, "Ack & Brunt", sub_consts.Sword_Shield),
    ...
    i(group_consts.Melee, "Kesheg", sub_consts.Polearm),
    i(group_consts.Melee, "Orthos", sub_consts.Polearm),
    i(group_consts.Melee, "Orthos Prime", sub_consts.Polearm),
    i(group_consts.Melee, "Serro", sub_consts.Polearm),
    i(group_consts.Melee, "Sydon", sub_consts.Polearm),
    i(group_consts.Melee, "Sydon Vaykor", sub_consts.Polearm),
    i(group_consts.Melee, "Tonbo", sub_consts.Polearm),
    ...
    i(group_consts.Melee, "Cerata", sub_consts.Glaive),
    ...
    i(group_consts.Melee, "Scoliac", sub_consts.Whip),
    ...
    i(group_consts.Melee, "Jat Kittag", sub_consts.Hammer),
    ...
    i(group_consts.Melee, "Nikana", sub_consts.Nikana),
    ...
    i(group_consts.Melee, "Venka", sub_consts.Claws),
    i(group_consts.Melee, "Venka Prime", sub_consts.Claws),
    i(group_consts.Melee, "Anku", sub_consts.Scythe),
    i(group_consts.Melee, "Caustacyst", sub_consts.Scythe),
    ...
    i(group_consts.Melee, "Shaku", sub_consts.Nunchaku),
    i(group_consts.Melee, "Lacera", sub_consts.Blade_Whip),
    i(group_consts.Melee, "Mios", sub_consts.Blade_Whip),
    i(group_consts.Melee, "Dark Split-Sword", sub_consts.Hybrid),
    ...
    i(group_consts.Archwing, "Grattler", sub_consts.Gun),
    ...
    i(group_consts.Archwing, "Knux", sub_consts.Melee),
    ...
    i(group_consts.Dojo, "Flux sub_consts.Rifle", sub_consts.Energy),
    ...
    i(group_consts.Dojo, "Buzlok", sub_consts.Chem),
    i(group_consts.Dojo, "Grattler", sub_consts.Chem),
    ...
    i(group_consts.Sentinel, "Laser sub_consts.Rifle", sub_consts.Rifle),
    i(group_consts.Sentinel, "Laser sub_consts.Rifle Prime", sub_consts.Rifle),
