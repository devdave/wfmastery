...
wfmastery_data = [
    ...
    #Archwing
    i(WFCategories.Archwing_Equipment, "Corvas", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Cyngas", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Dual Decurion", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Fluctus", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Grattler", WFSubcategories.Gun, is_dojo=True, special=WFSpecials.Chem_lab),
    i(WFCategories.Archwing_Equipment, "Imperator", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Imperator Vandal", WFSubcategories.Gun, special=WFSpecials.Vandal),
    i(WFCategories.Archwing_Equipment, "Phaedra", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Velocitus", WFSubcategories.Gun),
    i(WFCategories.Archwing_Equipment, "Agkuza", WFSubcategories.Melee),
    i(WFCategories.Archwing_Equipment, "Centaur", WFSubcategories.Melee),
    i(WFCategories.Archwing_Equipment, "Kaszas", WFSubcategories.Melee),
    i(WFCategories.Archwing_Equipment, "Knux", WFSubcategories.Melee, is_dojo=True, special=WFSpecials.Chem_lab),
    i(WFCategories.Archwing_Equipment, "Onorix", WFSubcategories.Melee),
    i(WFCategories.Archwing_Equipment, "Rathbone", WFSubcategories.Melee),
    i(WFCategories.Archwing_Equipment, "Veritux", WFSubcategories.Melee),
    i(WFCategories.Archwing_Equipment, "Veritux Prisma", WFSubcategories.Melee, special=WFSpecials.Prisma),
    #Dojo
